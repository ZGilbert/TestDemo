...
-(id) initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        coverImage = [UIImage imageNamed:@"51"];
...
//    CGContextDrawPath(context,kCGPathFill);
    ...
    CGRect touchRect = CGRectMake(0, 0, 50, 50);
    CGContextDrawImage(context, touchRect, image);
    CGContextRestoreGState(context);

    [self coverImageView:context];
...
-(void) coverImageView:(CGContextRef)context
{
    CGImageRef image1 = coverImage.CGImage;
    CGContextSaveGState(context);
    
    CGContextRotateCTM(context, M_PI);
    CGContextTranslateCTM(context, -50, -50);
    
    CGRect touchRect1 = CGRectMake(0, 0, 50, 50);
