...
//    CFStringRef a = CGImageSourceGetType(gifSource);
    
    // get frame count
    size_t frameCount = CGImageSourceGetCount(gifSource);
    ZLOG(@"frameCount : %zu", frameCount); //75
    for (size_t i = 0; i < frameCount; ++i) {
        ...
        ZLOG(@"kCGImagePropertyGIFDictionary %@", [dict valueForKey:(NSString*)kCGImagePropertyGIFDictionary]);
